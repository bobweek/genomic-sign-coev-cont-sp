...
allkeeprs_cor = which(iscaf_cor!=0 & iscaf_cor< -0.02)
cslkeeprs_cor = which(csl_iscaf_cor!=0 & csl_iscaf_cor< -0.02)

length(allkeeprs_cor)
length(cslkeeprs_cor)

allkeeprs_cov = which(iscaf_cov!=0 & iscaf_cov< -0.001)
cslkeeprs_cov = which(csl_iscaf_cov!=0 & csl_iscaf_cov< -0.001)
...
lim_cor = max(abs(csl_iscaf_cor$iscaf[cslkeeprs_cor]))
lim_cov = max(abs(csl_iscaf_cov$iscaf[cslkeeprs_cov]))

max_cor = max(csl_iscaf_cor$iscaf[cslkeeprs_cor])
max_cov = max(csl_iscaf_cov$iscaf[cslkeeprs_cov])

min_cor = min(csl_iscaf_cor$iscaf[cslkeeprs_cor])
min_cov = min(csl_iscaf_cov$iscaf[cslkeeprs_cov])
