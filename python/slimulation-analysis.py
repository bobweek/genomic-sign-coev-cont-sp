...
summary_time_series = pd.DataFrame(columns=[
            "Nh","Np","pr_unhosted","pr_unparasitized","pprh_m","pprh_v","pntcorr"])
# summary_time_series = pd.DataFrame(columns=[
...
for t in time_pts:
    ...
    thg = pd.DataFrame([[Nh,Np,pr_unhosted,pr_unparasitized,pprh_m,pprh_v,pntcorr]], 
        columns=["Nh","Np","pr_unhosted","pr_unparasitized","pprh_m","pprh_v","pntcorr"])
    # thg = pd.DataFrame([[
    #     pretained,Nh,Np,pr_unhosted,pr_unparasitized,pprh_m,pprh_v,
    #     pntcorr,dsccorr,unocc_h,unocc_p,Nh_m,Np_m,Nh_stdv,Np_stdv,
    #     Nh_cv,Np_cv,Ncorr,rh_m,rp_m,rh_stdv,rp_stdv,rh_rp,
