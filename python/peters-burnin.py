...
hts = msprime.sim_ancestry(samples=10, population_size=10, sequence_length=10)
...
pts = msprime.sim_ancestry(samples={"pop_0": 0, "pop_1": 10}, demography=demog, sequence_length=20)
